    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            ...
            catch (Exception ex)
            {
                NLog.LogManager.GetCurrentClassLogger().Log(NLog.LogLevel.Error, 
                    DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss")+"Account/Register hata", ex);
                _logger.LogError(ex, "Account/Register hata");
            ...
            string code)
        {
            ...
            catch (Exception ex)
            {
                ...
                NLog.LogManager.GetCurrentClassLogger().Log(NLog.LogLevel.Error,
                    DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss")+"Account/ConfirmEmail hata", ex);
                return RedirectToAction("Error", "Home");
            }
        }
        ...
        public async Task<IActionResult> Login(LoginViewModel model)
        {
            try
            {
                ...
                _logger.LogInformation(DateTime.Now.ToString("dd/MM/yyyy HH:mm")+" Giriş yapan : " + user.UserName);
            ...
            {
                ModelState.AddModelError("", "Beklenmedik bir hata oluştu!");
                _logger.LogError(ex, DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss") +" Account/Login hata");
                return RedirectToAction("Error", "Home");
            }
        }
        ...
        public async Task<IActionResult> ResetPassword(string email)
        {
            ...
            catch (Exception ex)
            {
                ...
                NLog.LogManager.GetCurrentClassLogger().Log(NLog.LogLevel.Error,
                    DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss")+" Account/ResetPassword hata", ex);
                return RedirectToAction("Error", "Home");
            }
        }
        ...
        public async Task<IActionResult> ConfirmResetPassword(ResetPasswordViewModel model)
        {
            ...
            catch (Exception ex)
            {
                ...
                NLog.LogManager.GetCurrentClassLogger().Log(NLog.LogLevel.Error,
                    DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss")+" Account/ConfirmResetPassword hata", ex);
                return RedirectToAction("Error", "Home");
            }
        }
